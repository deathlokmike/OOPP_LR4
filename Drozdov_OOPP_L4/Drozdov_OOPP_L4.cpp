...
// Drozdov_OOPP_L4.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDrozdovOOPPL4App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDrozdovOOPPL4App::OnAppAbout)
...
// Создание CDrozdovOOPPL4App

CDrozdovOOPPL4App::CDrozdovOOPPL4App() noexcept
{
	// TODO: замените ниже строку идентификатора приложения строкой уникального идентификатора; рекомендуемый
	// формат для строки: ИмяКомпании.ИмяПродукта.СубПродукт.СведенияОВерсии
	SetAppID(_T("DrozdovOOPPL4.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CDrozdovOOPPL4App

CDrozdovOOPPL4App theApp;


// Инициализация CDrozdovOOPPL4App

BOOL CDrozdovOOPPL4App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDrozdovOOPPL4Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CDrozdovOOPPL4View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CDrozdovOOPPL4App
...
void CDrozdovOOPPL4App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
